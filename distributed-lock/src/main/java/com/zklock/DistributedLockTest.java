...
/**
 * Test application for ZKDistributedLock, demonstrating concurrent access control.
 */
            ...
            try {
                ...
                for (int i = 0; i < OPERATIONS_PER_THREAD; i++) {
                    try {
                        ...
                        LOG.debug("Worker {} incremented counter to {}", id, sharedCounter.get());
                ...
                LOG.debug("Worker {} completed all operations", id);
            } catch (Exception e) {
